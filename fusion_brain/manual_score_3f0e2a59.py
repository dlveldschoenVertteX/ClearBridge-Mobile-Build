"""Manual real-pipeline scoring of fusion_v1 capture 3f0e2a59 (2026-09-03
...
CID = '3f0e2a59-88e8-454b-b383-9e9d6d00fb22'
CACHE = os.path.join(HERE, 'results', 'cache', '3f0e2a59')
os.makedirs(CACHE, exist_ok=True)
IMGDIR = '/tmp/3f0e2a59_imgs'
