"""Manual real-pipeline scoring of fusion_v1 capture 24a2e023 (2026-09-02
...
CID = '24a2e023-7a42-4a2b-8c19-8cbca8d6c81a'
CACHE = os.path.join(HERE, 'results', 'cache', '24a2e023')
os.makedirs(CACHE, exist_ok=True)
IMGDIR = '/tmp/24a2e023_imgs'
