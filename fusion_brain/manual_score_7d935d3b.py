"""Manual real-pipeline scoring of fusion_v1 capture 7d935d3b (2026-09-02
...
CID = '7d935d3b-fb1e-4028-a73d-e692c520f01f'
CACHE = os.path.join(HERE, 'results', 'cache', '7d935d3b')
os.makedirs(CACHE, exist_ok=True)
IMGDIR = '/tmp/7d935d3b_imgs'
