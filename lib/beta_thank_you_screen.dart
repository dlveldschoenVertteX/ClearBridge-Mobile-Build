...
/// Final screen of the beta flow — shown after ClearCoins have been
/// tallied. Lets the tester either capture again (loops back into the
/// active flavor's capture route) or exit the app entirely.
class BetaThankYouScreen extends StatelessWidget {
  const BetaThankYouScreen({super.key});
