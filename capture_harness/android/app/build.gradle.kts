...
android {
    namespace = "com.clearbridge.captureharness"
    ...
    defaultConfig {
        applicationId = "com.clearbridge.captureharness"
    ...
    buildTypes {
        release {
            // Signed with the debug key so this side-loadable test build
            // doesn't need its own signing config.
