...
NBIS_PNG='png'
OPENJP2='openjp2' 
# Trimmed from upstream's 'commonnbis an2k bozorth3 imgtools mindtct nfseg
# nfiq pcasys' -- this vendored copy only ships the packages mindtct/bozorth3
# actually link against (traced via their Makefiles' LIBS lists); nfseg,
# nfiq, and pcasys are not vendored. See vendor/nbis/PROVENANCE.md.
REG_LIBS='commonnbis an2k bozorth3 imgtools mindtct'
...
# pcasys and jpeg2k/jasper touch-ups removed below -- this vendored copy
# deliberately does not ship those packages (not needed by mindtct/
# bozorth3; see PROVENANCE.md). Upstream's unconditional pcasys/jasper
# steps have been dropped rather than left to fail-and-continue.
